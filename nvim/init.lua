	...
	},
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>l", function()
				...
				vim.diagnostic.show()
			end, { expr = true, desc = "Lint current buffer" })
			vim.keymap.set("n", "<leader>o", function()
				vim.diagnostic.setloclist()
			end, { noremap = true, silent = true, desc = "Show diagnostic results in loclist" })
		end,
	},
	{
...
local on_attach = function(client, bufnr)
  ...
  nmap("<leader>ca", require("fzf-lua").lsp_code_actions, "[C]ode [A]ction")
	...
	nmap("gI", function() require("fzf-lua").lsp_implementations({jump_to_single_result = true}) end, "[G]oto [I]mplementation")
